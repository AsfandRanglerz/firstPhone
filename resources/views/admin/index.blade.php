        ...
        <section class="section">
            <div class="row mb-3">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <a href="{{ route('vendor.index') }}" style="text-decoration: none; color: inherit;">
                        <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 pl-0">
                                            <div class="banner-img">
                                                <img src="{{ asset('public/admin/assets/img/banner/vendors.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-statistic-4">
                                <div class="align-items-center justify-content-between">
                                    <div class="row">
                                        ...
                                        <div class="col-6 pl-0">
                                            <div class="banner-img">
                                                <img src="{{ asset('public/admin/assets/img/banner/customers.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-statistic-4">
                                <div class="align-items-center justify-content-between">
                                    <div class="row">
                                        ...
                                        <div class="col-6 pl-0">
                                            <div class="banner-img">
                                                <img src="{{ asset('public/admin/assets/img/banner/orders.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
