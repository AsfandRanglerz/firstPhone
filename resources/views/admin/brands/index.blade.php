        ...
        $(document).ready(function() {
            ...
            $('#brandForm').submit(function(e) {
                ...
                let url = id ?
                    ...
                    "{{ route('brands.store') }}";
                let method = id ? 'POST' : 'POST'; // update is POST as per your request
                    ...
                    success: function(res) {
                        if (id) {
                            ...
                            let newRow = table.row.add([
                                ...
                                res.data.name,
                                `<div class="d-flex gap-1">
                            <button class="btn btn-primary editBrand" data-id="${res.data.id}" data-name="${res.data.name}" data-slug="${res.data.slug}">
                                <i class="fa fa-edit"></i>
                            </button>
